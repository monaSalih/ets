...
<html lang="en" class="h-100">
  <head>
    ...
    <title>Administration main page · Boosted v4.6</title>
...
<div class="skiplinks container-fluid">
  ...
  <a href="#news-table" class="sr-only sr-only-focusable">Skip to news list</a>
</div>
<header role="banner">
  <nav role="navigation" class="navbar navbar-dark bg-dark navbar-expand-md" aria-label="Main navigation">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="../assets/dist/img/orange_logo.svg" alt="Back to homepage" title="Back to homepage" width="50" height="50" loading="lazy"/>
      </a>
    ...
    <table id="news-table" class="table tablesorter mb-5">
      ...
      <thead class="cf">
        <tr>
          ...
          <th scope="col" class="header">Test</th>
